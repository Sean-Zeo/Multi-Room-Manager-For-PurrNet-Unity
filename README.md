...
A lightweight, single‑server solution for PurrNet that lets you run **multiple isolated game rooms** all within one server using PurrNet's built in scene isolation.  
